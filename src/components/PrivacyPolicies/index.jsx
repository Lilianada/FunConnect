    ...
    <section className="policiesSection">
      ...
      <div className="policiesSection_content">
        ...
        <div className="policiesSection_contentParagraph">
          ...
          <p className="policiesSection_contentText">
            We usually share information to some set of persons, bodies,
            organizations or corporations but it might fulfill any of our
            condition precedent which is; if you have granted us the permission
            to share your information with a third party or if we have duly
            notified you of such (via our privacy policy) or if such information
            is just aggregate information as earlier pointed out in this privacy
            policy. If our reasons for sharing this information of yours is in
            accordance with any of this conditions, then we shall presume that
            you have granted requisite consent needed to share your information
            with a third party. Those whom your information is shared with are
            highlighted below;
          </p>
          ...
          <p className="policiesSection_contentText">
            Our family companies may be privy to your information in order to
            receive aid/help to improve our services from them. We run an
            interconnected group of companies which explains why we might rely
            on another affiliate to achieve a new feat and to meet your teeming
            requests on our platform.
          </p>

          <h4 className="policiesSection_contentSubtitle">4.2 The Public</h4>
          <p className="policiesSection_contentText">
            We share your information with the public as every piece of writing
            or activities that fall with the “user content” purview is regarded
            as public information because all everyone in your circle of friends
            and related subject category can view all posts/comments/replies and
            they will be able to access the comments/replies/posts in other
            categories, but the only posts that will primarily be visible to
            them are posts in their category. Also, Users can search for related
            posts, also, a search engine that can be used to search for topics,
            keywords, individuals etc. but it needs to be installed. Basically,
            we share your information with the public and we can only admonish
            you to be careful of the content you put up as they are shared with
            the public.
          </p>
          ...
          <p className="policiesSection_contentText">
            ...
            privacy policy before commencing activities on their platform.
          </p>

          <h4 className="policiesSection_contentSubtitle">4.4 Our Agents</h4>
          <p className="policiesSection_contentText">
            Agents, in this case, would mean anyone acting as a “service
            provider” “consultant” “engineer” or any other person contracted to
            improve or rather enhance our services to you. These people have
            access to your information. These people develop new service
            products with an assessment of your information they can be able to
            predict your need. These agents also need to access to your data to
            combat spamming and other activities with malicious tendencies.
            Unless there is a different order, our agents are mandated to stay
            within the scope and duration of what is necessary to enhance our
            duties. You wouldn’t have to worry about our agents because we have
            a confidential agreement which ensures the safeguard of the
            information about to you shared to them by us in the course of
          ...
          <p className="policiesSection_contentText">
            Some persons, firms, organizations and so on are described as
            business partners in this sense, we may agree to sell some of our
            business assets. One of our transferable commodities in this kind of
            transaction is your personal information. Though this information
            can only be used in accordance with this privacy policy and not for
        ...
        <div className="policiesSection_contentParagraph">
          ...
          <p className="policiesSection_contentText">
            ...
            step (don’t go!) of deleting your account but we hope we are able to
            provide you with quality service and it doesn’t get to that.
            <br />
            <br />
            Though deleting your account does not mean all your user contents
            would vanish too because the reblogged posts would still remain. We
            informed you earlier that the deleting a post that has been
            reblogged so many times might prove abortive as they now have their
            different right over the contents they post and it has fallen out
            your jurisdiction to delete. Though it might take a while to get
            your data off our archives and servers, we can assure you that the
            deletion would take effect within a very reasonable period.
            <br />
            <br />
            In addition, judging by the nature of the sharing process on the
            services, some of the activities categorized as “public” on your
            account before you decided to delete them may still be stored and
            accessible to the public though within a reasonable time-frame.
          </p>
        </div>

        <div className="policiesSection_contentParagraph">
          <h3 className="policiesSection_contentTitle">
            6. Global Privacy Policy
          </h3>
          <p className="policiesSection_contentText">
            We operate a world class service which implies that we have a global
            coverage on our platform, in lieu of this, we are aware and duly
            recognize laws guiding the use and sharing of data in a different
            jurisdiction. We express deep understanding in the aspect of privacy
            law as it guides data protection and the relationship of government
            when it comes to storing and sharing data of their citizen.
            <br />
            <br />
            For example, we are aware that a high level of protection of rights
            of information must be put in place when personal data are being
            shared beyond the shores of the Africa Union Countries. If you feel
            some of your right s to privacy is being silenced, you can contact
            us, however, participants within the AU would take full
            responsibility for sharing data and personal information with a
            third party out the AU.
          </p>
        </div>
        ...
        <div className="policiesSection_contentParagraph">
          ...
          <p className="policiesSection_contentText">
            By children, we mean, persons below the legally accepted age of
            adulthood (minor), this implies that this service is not meant for
            you if you are legally defined as a child by the laws in the
            jurisdiction. We put up this protection because there is a tenable
            presumption that as a child, you do not have the right to make
            decisions and in this case, your parent/guardians are not permitted
        ...
        <div className="policiesSection_contentParagraph">
          ...
          <p className="policiesSection_contentText">
            Some situations might mandate the amendment/alteration/changes in
            this privacy policy, we, therefore, implore you to check this page
            regularly to be abreast of material changes that might have
            occurred. You might also have to refer the last modified date.
          </p>
        </div>
        <div className="policiesSection_contentParagraph">
            <h3 className="policiesSection_contentTitle">
