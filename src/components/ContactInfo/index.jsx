            ...
            <div className="contactInfo_wrap">
                <div className="contactInfo_content">
                    ...
                    <p className="contactInfo_text">
                        ...
                        <a href="mailto:Info@funconnect.app" className="mailTo">
                            Info@funconnect.app
                        </a>
                    </p>
                ...
                <div className="contactInfo_content">
                    ...
                    <p className="contactInfo_text2">
                        Send us an email at {" "}
                        <a href="mailto:careers.funconnect@gmail.com" className="mailTo"> careers.funconnect@gmail.com
                        </a>
                    </p>
                </div>
            </div>
