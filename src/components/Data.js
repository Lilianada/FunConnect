export const Accordion = [
  ...
  },
  {
    ...
    content:
      "The mobile app is available for Apple and Android devices on the App Store and on Play Store",
  },
  {
    id: 3,
    title: "Will I pay to use the Funconnect app?",
    content:
      "No. The app is completely FREE on Apple Store and Google Play Store.",
  },
  {
    id: 4,
    title: "What type of events will be featured on Funconnect?",
    content:
      "Concerts, Fiestas, Sip & Paint, Fashion Shows, Standups, Food Festivals, and many more.",
  },
  {
    id: 5,
